package com.startspring.springbootangularjs1.dao;
...
public class EmployeeDAO {
    ...
    private static void initEmps() {
        Employee emp1 = new Employee(1L, "E01", "Василий", "Водитель");
        Employee emp2 = new Employee(2L, "E02", "Мария", "Продавец");
        Employee emp3 = new Employee(3L, "E03", "Иван", "Менеджер");
        Employee emp4 = new Employee(4L, "E04", "Максим", "Менеджер");
        Employee emp5 = new Employee(5L, "E05", "Георгий", "Грузчик");
